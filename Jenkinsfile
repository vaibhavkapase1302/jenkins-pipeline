...
pipeline {
    ...
    parameters {
        string(name: 'GIT_BRANCH', defaultValue: 'version2', description: 'Git branch to clone')
        string(name: 'IMAGE_TAG', defaultValue: 'version-v2', description: 'Docker image tag')
    }
